...
pub const static_utilities = std.StaticStringMap([]const Declaration).initComptime(.{
    ...
    .{ "inset-bs-auto", &[_]Declaration{.{ .property = "inset-block-start", .value = "auto" }} },
    .{ "inset-be-auto", &[_]Declaration{.{ .property = "inset-block-end", .value = "auto" }} },
    .{ "inset-bs-full", &[_]Declaration{.{ .property = "inset-block-start", .value = "100%" }} },
    .{ "inset-be-full", &[_]Declaration{.{ .property = "inset-block-end", .value = "100%" }} },
    .{ "-inset-bs-full", &[_]Declaration{.{ .property = "inset-block-start", .value = "-100%" }} },
    .{ "-inset-be-full", &[_]Declaration{.{ .property = "inset-block-end", .value = "-100%" }} },
...
fn spacingProperty(root: []const u8) []const []const u8 {
    const map = std.StaticStringMap([]const []const u8).initComptime(.{
        ...
        .{ "inset-bs", &[_][]const u8{"inset-block-start"} },
        .{ "inset-be", &[_][]const u8{"inset-block-end"} },
        .{ "top", &[_][]const u8{"top"} },
