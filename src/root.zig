...
/// - `minify`: When true output is compressed; when false it is pretty-printed
...
///
/// Returns CSS string. Caller owns the returned memory.
pub fn compile(
    ...
    return compiler.compile(alloc, candidates, theme_json, include_preflight, minify, custom_css, custom_utilities_json, plugin_css);
}
