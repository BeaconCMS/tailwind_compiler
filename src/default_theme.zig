...
pub const font_sizes = [_]ThemeEntry{
    ...
    .{ .key = "--text-xs--line-height", .value = "calc(1 / 0.75)" },
    .{ .key = "--text-sm", .value = "0.875rem" },
    .{ .key = "--text-sm--line-height", .value = "calc(1.25 / 0.875)" },
    .{ .key = "--text-base", .value = "1rem" },
    .{ .key = "--text-base--line-height", .value = "calc(1.5 / 1)" },
    .{ .key = "--text-lg", .value = "1.125rem" },
    .{ .key = "--text-lg--line-height", .value = "calc(1.75 / 1.125)" },
    .{ .key = "--text-xl", .value = "1.25rem" },
    .{ .key = "--text-xl--line-height", .value = "calc(1.75 / 1.25)" },
    .{ .key = "--text-2xl", .value = "1.5rem" },
    .{ .key = "--text-2xl--line-height", .value = "calc(2 / 1.5)" },
    .{ .key = "--text-3xl", .value = "1.875rem" },
    .{ .key = "--text-3xl--line-height", .value = "calc(2.25 / 1.875)" },
    .{ .key = "--text-4xl", .value = "2.25rem" },
    .{ .key = "--text-4xl--line-height", .value = "calc(2.5 / 2.25)" },
