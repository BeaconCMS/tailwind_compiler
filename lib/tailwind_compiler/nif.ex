defmodule TailwindCompiler.NIF do
  ...
  pub fn compile(candidates_term: beam.term, theme_json_term: beam.term, preflight_term: beam.term) ![]u8 {
      ...
      const css = try compiler.compile(alloc, candidates, theme_json, include_preflight);
